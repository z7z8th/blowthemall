...
MainWindow::MainWindow(QTcpSocket *socket, QWidget *parent) :
    ...
    peer(new Phobos::TcpHelper(this))
{
    ui->setupUi(this);
    ...
    connect(peer, SIGNAL(readyRequest(QSharedPointer<Phobos::ResponseHandler>)),
            this, SLOT(onReadyRequest(QSharedPointer<Phobos::ResponseHandler>)));
...
void MainWindow::onReadyRequest(QSharedPointer<Phobos::ResponseHandler> responseHandler)
{
