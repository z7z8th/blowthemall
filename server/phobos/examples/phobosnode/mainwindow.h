...
private slots:
    ...
    void onReadyRequest(QSharedPointer<Phobos::ResponseHandler> responseHandler);
...
private:
    Ui::MainWindow *ui;
    Phobos::TcpHelper *peer;
    QHash< QVariant, QSharedPointer<Phobos::ResponseHandler> > handlers;
};
